...
const player1 = competidores[4]

const player2 = competidores[3]
...
async function playRaceEngine(character1, character2) {
    for (let round = 1; round <= 10; round++){
        ...
        if (block === "CONFRONTO"){
            ...
            let radomic = Math.floor(Math.random() * 100)
            let tipo
            ...
            if(powerResult1 > powerResult2 && character2.PONTOS > 0){
                ...
                if (tipo === "bomba" && character2.PONTOS > 1){
            ...
            if(powerResult2 > powerResult1 && character1.PONTOS > 0){
                ...
                if (tipo === "bomba" && character1.PONTOS > 1){
